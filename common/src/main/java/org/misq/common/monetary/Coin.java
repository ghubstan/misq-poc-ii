...
package org.misq.common.monetary;
...
import static org.misq.common.monetary.MonetaryFormat.BTC;
...
public final class Coin implements Monetary, Comparable<Coin>, Serializable {
    ...
    private static final MonetaryFormat FRIENDLY_FORMAT = BTC.minDecimals(2).repeatOptionalDecimals(1, 6).postfixCode();
    private static final MonetaryFormat PLAIN_FORMAT = BTC.minDecimals(0).repeatOptionalDecimals(1, 8).noCode();
